        ...
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white border border-slate-200 rounded-3xl max-w-3xl w-full max-h-[92vh] flex flex-col shadow-2xl overflow-hidden relative">
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 bg-slate-50/50">
              <h3 className="font-bold text-slate-900 text-base">Add New Algorithmic Question</h3>
              <button
            ...
            <form onSubmit={handleCreateQuestion} className="flex-1 overflow-y-auto p-6 space-y-4 text-xs pr-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl p-2.5 text-slate-900 placeholder-slate-400 focus:bg-white focus:outline-none focus:border-indigo-500 font-mono"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-slate-900 placeholder-slate-400 focus:bg-white focus:outline-none focus:border-indigo-500 font-mono"
                />
              </div>

              {/* Public Test Case */}
              <div className="p-4 bg-slate-50/80 rounded-2xl border border-slate-200/80 space-y-2.5">
                <span className="font-semibold text-blue-700 block">Sample Public Test Case</span>
                <div className="grid grid-cols-2 gap-2.5">
                  <input
                    ...
                    className="bg-white border border-slate-200 rounded-xl p-2.5 text-slate-900 placeholder-slate-400 font-mono focus:outline-none focus:border-indigo-500"
                  />
                  <input
                    type="text"
                    ...
                    className="bg-white border border-slate-200 rounded-xl p-2.5 text-emerald-600 placeholder-slate-400 font-mono focus:outline-none focus:border-indigo-500"
                  />
                </div>
              </div>
              ...
              {/* Hidden Test Case */}
              <div className="p-4 bg-slate-50/80 rounded-2xl border border-slate-200/80 space-y-2.5">
                <span className="font-semibold text-amber-700 block">Evaluation Hidden Test Case (Server-Only)</span>
                <div className="grid grid-cols-2 gap-2.5">
                  <input
                    type="text"
